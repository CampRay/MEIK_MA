...
namespace MEIKScreen.Common
{
    public class Win32Api
    {
        ...
        //设置一个窗体的显示状态,0隐藏，1显示:   SW_HIDE = 0; SW_NORMAL = 1; SW_MAXIMIZE = 3; SW_SHOWNOACTIVATE = 4; SW_SHOW = 5; SW_MINIMIZE = 6; SW_RESTORE = 9; SW_SHOWDEFAULT = 10;
        [DllImport("user32.dll")]
        public static extern bool ShowWindow(IntPtr hWnd,int nCmdShow);
        //设置一个窗体的显示状态, SW_HIDE = 0; SW_NORMAL = 1; SW_MAXIMIZE = 3; SW_SHOWNOACTIVATE = 4; SW_SHOW = 5; SW_MINIMIZE = 6; SW_RESTORE = 9; SW_SHOWDEFAULT = 10;        
        [DllImport("user32.dll")]
